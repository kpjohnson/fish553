...
subtitle: "FISH 553 &nbsp; &nbsp; University of Washington &nbsp; &nbsp; Autumn 2020"
output:
  html_document:
    toc: true
    toc_float: true
...
This course will introduce students to Advanced R programming within the context of the aquatic and fishery sciences. Students will learn how to use functions and for loops, practice foundational programming principles and debugging approaches, organize large projects, and be introduced to the `rmarkdown` package. This course also briefly introduces students to R programming philosophies (*e.g.*, `tidyverse`) and discusses the merits of open science and reproducibility. In general, students will use case studies from various fisheries disciplines and focus on critically evaluating data documentation and quality assurance, integrating multiple data sources, formatting data for statistical analyses, and preparing analysis reports.
...
M/W from 11:30 am - 1:20 pm in ~~MGH 044~~ via Zoom

First class meeting: 10/31/2020 

Last class meeting: 12/09/2020
